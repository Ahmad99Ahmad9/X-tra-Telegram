...
async def amireallyalive(alive): 
    ...
    await alive.edit("**`اسم المطور ψ(｀beno´)ψ`**\n\n" 
                     "`اصدار التنصيب: 6.9.0\nلغة البوت : python\nDev beno:` @tbeno\n" 
                     "`تم التنصيب بواسطة:` [⌯ #beno](tg://user?id=873921077)\n" 
                     "`يمكنك مراسلتي لاي خلل حاصل : استخدم امر .alive اذا اعتقدت ان البوت توقف!\n\nلرؤيه الاوامر ارسل.help\n`" 
                     f"`حسابي الرسمي`: {DEFAULTUSER}\n" 
                     "[قناة البوت اشترك ليصلك كل ما هو جديد](https://t.me/PingPanter)")
